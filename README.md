...
- [Скриншоты](#-скриншоты-интерфейса)
...
<table>
  <tr>
    <td align="center">
      <img src="docs/images/Вход.png" width="400" alt="Страница входа"><br>
      <em>Страница входа в систему</em>
    </td>
    <td align="center">
      <img src="docs/images/Рек_сис.png" width="400" alt="Главная страница"><br>
      <em>Персональные рекомендации</em>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="docs/images/Корзина.png" width="400" alt="Корзина покупок"><br>
      <em>Корзина с товарами</em>
    </td>
    <td align="center">
      <img src="docs/images/Заказ_оформлен.png" width="400" alt="Подтверждение заказа"><br>
...
Система была протестирована на данных Instacart (3.4M заказов, 200K пользователей):

| Метрика | Baseline (popular-based) | TF-IDF Collaborative | Улучшение | Охват пользователей |
|---------|--------------------------|---------------------|-----------|-------------------|
| **Precision@10** | 0.0735                   | 0.1638 | **+122.9%** | 54% |
| **Recall@10** | 0.0682                   | 0.1955 | **+186.8%** | 54% |
| **Hit Rate@10** | 0.4680                   | 0.7290 | **+55.8%** | 30% |
